...
glyph = Text(x=0.25, y=-0.19, text="label", text_font_size='9pt', text_font_style='bold', text_color='turquoise')
snr_plot.add_glyph(textlabel, glyph)
#else: 
   #print 'snr_ymax_ defined'
   #snr_plot.quad(top = [snr_ymax_*0.1], left=[0.2], right=[3.5], bottom=[snr_ymin_ - 0.1*snr_ymax_], color="white")
   #glyph = Text(x=0.25, y=snr_ymax_*0.08, text="label", text_font_size='9pt')
...
# stars if that becomes important, which I think it will)
   ...
   #    solhr_ = solhr
    ...
    if planet.value == 'Early Mars' or planet.value == 'Mars':
